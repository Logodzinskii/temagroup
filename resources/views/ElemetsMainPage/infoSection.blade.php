...
<section class="container-fluid bg-primary text-white row d-flex justify-content-center align-items-center flex-wrap" style="position: relative">
    ...
    <div class="row col-10 d-flex row justify-content-start" style="z-index: 1; position: absolute; top:0;">
        <div class="title-section-white"></div>
        <ul class="col fs-5 list-unstyled text-white d-flex row align-items-baseline"  style="min-height: 40vh">
            <li>ДОЛГОВЕЧНАЯ ФУРНИТУРА</li>
            <li>УДОБНЫЕ РУЧКИ</li>
            <li>СИСТЕМЫ ХРАНЕНИЯ</li>
            <li>ВЫДВИЖНЫЕ СИСТЕМЫ</li>
        </ul>
        <div class="col d-flex justify-content-center align-items-center flex-wrap" style="height: 100%">
            <p class="col-12" >
