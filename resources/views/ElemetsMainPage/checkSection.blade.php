<h2 class="text-center title-section-dark" style="padding: 20px">ЗАКАЗАТЬ МЕБЕЛЬ У НАС - ПРОСТО</h2>
<section class="col-lg-12 row bg-primary text-white justify-content-around p-0 m-0" style="min-height: 20vh">
    ...
    <div class="d-flex row justify-content-start col-lg-3 flex-wrap " >
