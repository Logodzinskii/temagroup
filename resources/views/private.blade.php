...
<head>
    ...
    <x-header></x-header>
    <body class="d-flex justify-content-center row">
        <div class="col-12 col-sm-10">
        @h2dk(ПОЛИТИКА В ОТНОШЕНИИ ОБРАБОТКИ ПЕРСОНАЛЬНЫХ ДАННЫХ)
        1. Общие положения<br/>
        Настоящая политика обработки персональных данных составлена в соответствии с требованиями Федерального закона от 27.07.2006. № 152-ФЗ «О персональных данных» (далее — Закон о персональных данных) и определяет порядок обработки персональных данных и меры по обеспечению безопасности персональных данных, предпринимаемые Иваном (далее — Оператор).<br/>
        1.1. Оператор ставит своей важнейшей целью и условием осуществления своей деятельности соблюдение прав и свобод человека и гражданина при обработке его персональных данных, в том числе защиты прав на неприкосновенность частной жизни, личную и семейную тайну.<br/>
        1.2. Настоящая политика Оператора в отношении обработки персональных данных (далее — Политика) применяется ко всей информации, которую Оператор может получить о посетителях веб-сайта <a href="/" class="link-dark">компания-тема.рф</a>.<br/>
        ...
        2.3. Веб-сайт — совокупность графических и информационных материалов, а также программ для ЭВМ и баз данных, обеспечивающих их доступность в сети интернет по сетевому адресу <a href="/" class="link-dark">компания-тема.рф</a>.<br/>
        ...
        2.8. Персональные данные — любая информация, относящаяся прямо или косвенно к определенному или определяемому Пользователю веб-сайта <a href="/" class="link-dark">компания-тема.рф</a>.<br/>
        ...
        2.10. Пользователь — любой посетитель веб-сайта <a href="/" class="link-dark">компания-тема.рф</a>.<br/>
        ...
        2.15. Субъект персональных данных — любое физическое лицо, обладающее соответствующими персональными данными.<br/>
        2.16. Категории субъектов данных — субъекты, состоящие в договорных или иных гражданско-правовых отношениях с Оператором, планирующие заключить договоры или использовать услуги Оператора, посетители веб-сайта.<br/>
        ...
        — предоставление доступа Пользователю к сервисам, информации и/или материалам, содержащимся на веб-сайте <a href="/" class="link-dark">компания-тема.рф</a>.<br/>
        7.2. Также Оператор имеет право направлять Пользователю уведомления о новых продуктах и услугах, специальных предложениях и различных событиях. Пользователь всегда может отказаться от получения информационных сообщений, направив Оператору письмо на адрес электронной почты temagroupekb@gmail.com с пометкой «Отказ от уведомлений о новых продуктах и услугах и специальных предложениях».<br/>
        ...
        — Закон РФ «О защите прав потребителей»;<br/>
        — Гражданский кодекс РФ;<br/>
        — Патентный закон Российской Федерации от 23 сентября 1992 года № 3517−1 (далее Патентный закон);<br/>
        — Закон Российской Федерации от 9 июля 1993 года № 5351−1 «Об авторском праве и смежных правах» (далее Закон об авторском праве),
        ...
        — Закон Российской Федерации от 23 сентября 1992 года № 3526−1 «О правовой охране топологий интегральных микросхем».
        — Законом Российской Федерации от 6 августа 1993 года № 5605−1 «О селекционных достижениях»;
        ...
        — федеральные законы, иные нормативно-правовые акты в сфере защиты персональных данных;<br/>
        — согласия Пользователей на обработку их персональных данных, на обработку персональных данных, разрешенных для распространения.<br/>
        8.2. Оператор обрабатывает персональные данные Пользователя только в случае их заполнения и/или отправки Пользователем самостоятельно через специальные формы, расположенные на сайте <a href="/" class="link-dark">компания-тема.рф</a> или направленные Оператору посредством электронной почты. Заполняя соответствующие формы и/или отправляя свои персональные данные Оператору, Пользователь выражает свое согласие с данной Политикой.<br/>
        ...
        10.3. В случае выявления неточностей в персональных данных, Пользователь может актуализировать их самостоятельно, путем направления Оператору уведомление на адрес электронной почты Оператора temagroupekb@gmail.com с пометкой «Актуализация персональных данных».<br/>
        ...
        Пользователь может в любой момент отозвать свое согласие на обработку персональных данных, направив Оператору уведомление посредством электронной почты на электронный адрес Оператора temagroupekb@gmail.com с пометкой «Отзыв согласия на обработку персональных данных».<br/>
        ...
        11.3. Уничтожение персональных данных осуществляется следующим способом:<br/>
        — Для бумажных носителей персональных данных — разрезание, гидрообработка, сжигание, механическое уничтожение.<br/>
        — Для электронных носителей персональных данных — стирание на устройстве без возможности восстановления, физическое уничтожение микросхем, диска.<br/>
        11.4. Факт уничтожения оформляется актом.<br/>
        ...
        14.1. Пользователь может получить любые разъяснения по интересующим вопросам, касающимся обработки его персональных данных, обратившись к Оператору с помощью электронной почты temagroupekb@gmail.com.<br/>
        14.2. В данном документе будут отражены любые изменения политики обработки персональных данных Оператором. Политика действует бессрочно до замены ее новой версией.<br/>
            14.3. Актуальная версия Политики в свободном доступе расположена в сети Интернет по адресу <a href="/privacy/" class="link-dark">https://компания-тема.рф/privacy/</a>.<br/>
    </div>
    <x-footer></x-footer>
    </body>
